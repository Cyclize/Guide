...
**29\)** ~~Once you see page that looks something like this~~: ... ![](.gitbook/assets/23.png) \_\_
...
Click on the `Recheck Nameservers` button and if you see "Zone Verified" notification, you can start using your new IP right away! If you don't, Domain verification takes usually few minutes, no more than an hour. \_\_~~If you see page like this one~~: ...
